...
class Score():
    ...
    def show_score(self, first_player, second_player, turn):
        ...
        first_player_name = self.myfont.render(first_player.name, 1, (255,255,0))
        second_player_name = self.myfont.render(second_player.name, 1, (255,255,0))
        first_player_score = self.myfont.render(str(first_player.points), 1, (255,255,0))
        second_player_score = self.myfont.render(str(second_player.points), 1, (255,255,0))
